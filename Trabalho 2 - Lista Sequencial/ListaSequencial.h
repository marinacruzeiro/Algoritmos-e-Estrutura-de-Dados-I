 ...
 * No caso deste Trab é um int*/
typedef int elem;


/** Descritor de lista sequencial.
  * Pré-aloca um vetor de MAX posições dinamicamente na função create().*/
...
Antes de inserir: 
	Testar se a lista nao esta cheia(utilize função criada)
...
* @return posicao caso encontre, 0 se não encontrar*/
